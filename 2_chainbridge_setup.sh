...
cb-sol-cli --url $GATEWAY_RINKEBY --privateKey $PK --gasPrice 10000000000 bridge register-resource \
    --bridge $BRIDGE --handler $HANDLER_ERC721 --targetContract $TOKEN_ERC721 --resourceId $RESOURCE_ID_ERC721_RINKEBY_BINANCE
cb-sol-cli --url $GATEWAY_RINKEBY --privateKey $PK --gasPrice 10000000000 bridge register-resource \
    --bridge $BRIDGE --handler $HANDLER_ERC721 --targetContract $TOKEN_ERC721 --resourceId $RESOURCE_ID_ERC721_RINKEBY_POLYGON
cb-sol-cli --url $GATEWAY_RINKEBY --privateKey $PK --gasPrice 10000000000 bridge register-resource \
...
cb-sol-cli --url $GATEWAY_BINANCE --privateKey $PK --gasPrice 10000000000 bridge register-resource \
    --bridge $BRIDGE --handler $HANDLER_ERC721 --targetContract $TOKEN_ERC721 --resourceId $RESOURCE_ID_ERC721_BINANCE_RINKEBY
cb-sol-cli --url $GATEWAY_BINANCE --privateKey $PK --gasPrice 10000000000 bridge register-resource \
    --bridge $BRIDGE --handler $HANDLER_ERC721 --targetContract $TOKEN_ERC721 --resourceId $RESOURCE_ID_ERC721_BINANCE_POLYGON
cb-sol-cli --url $GATEWAY_BINANCE --privateKey $PK --gasPrice 10000000000 bridge register-resource \
...
cb-sol-cli --url $GATEWAY_POLYGON --privateKey $PK --gasPrice 10000000000 bridge register-resource \
    --bridge $BRIDGE --handler $HANDLER_ERC721 --targetContract $TOKEN_ERC721 --resourceId $RESOURCE_ID_ERC721_POLYGON_BINANCE
cb-sol-cli --url $GATEWAY_POLYGON --privateKey $PK --gasPrice 10000000000 bridge register-resource \
    --bridge $BRIDGE --handler $HANDLER_ERC721 --targetContract $TOKEN_ERC721 --resourceId $RESOURCE_ID_ERC721_POLYGON_RINKEBY
cb-sol-cli --url $GATEWAY_POLYGON --privateKey $PK --gasPrice 10000000000 bridge register-resource \
