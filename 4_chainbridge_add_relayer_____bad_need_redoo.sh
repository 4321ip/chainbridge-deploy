...
cb-sol-cli --url $GATEWAY_RINKEBY --privateKey $PK --gasPrice 10000000000 admin is-relayer \
    --relayer $RELAYER_ADDR2 \
    --bridge $BRIDGE
cb-sol-cli --url $GATEWAY_RINKEBY --privateKey $PK --gasPrice 10000000000 admin remove-relayer \
